...
Only the latest minor release of each supported major version receives security fixes. Consumers should stay current with tagged releases.
Patch-level updates are fast-forward compatible unless otherwise documented in the [CHANGELOG](../CHANGELOG.md).

## Reporting a Vulnerability

Please report suspected vulnerabilities **privately** via the GitHub Security Advisories.
...
- Vulnerabilities that stem from misuse of the API outside documented preconditions.
